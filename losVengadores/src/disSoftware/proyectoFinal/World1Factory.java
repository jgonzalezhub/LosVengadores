...
public class World1Factory implements EnemyFactory {
	...
	public Enemy createIronMan() {
		Enemy ironMan = new IronMan("Iron-Man", 30, 100,15, "JARVIS CLIP THAT", 30, null);
	...
	public Enemy createSpiderMan() {
		Enemy spiderMan = new SpiderMan("Spider-Man", 30, 80,20, "Don't mess with the amazing Spider-Man", 20, null);
	...
	public Enemy createThor() {
		Enemy thor = new Thor("Thor: God of Thunder", 35, 120,15, "Behold the God of Thunder", 40, null);
	...
	public Enemy createCaptainAmerica() {
		Enemy captainAmerica = new CaptainAmerica("Captain America", 35, 100,20, "AVENGERS ASSEMBLE", 20, null);
